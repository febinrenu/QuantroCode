@php
  $activeThemeSlug = 'generalhub-store';
  $themeTokens = \App\Support\StorefrontThemeRegistry::resolveTokens($activeThemeSlug, $s->theme_tokens ?? []);
  $accent500 = $themeTokens['color-accent-500'] ?? '#2857E0';
  $accent600 = $themeTokens['color-accent-600'] ?? '#1CB672';
  $accent700 = $themeTokens['color-accent-700'] ?? '#141F38';
  $accent800 = $themeTokens['color-accent-800'] ?? '#F5A623';
