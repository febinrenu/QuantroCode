        ...
        <form method="get" action="{{ route('store.shop') }}" class="p-4">
          ...
          <div class="mb-5">
            ...
            <div class="flex items-center gap-2">
              <input type="number" name="min" value="{{ $min }}" placeholder="{{ __('messages.MinPrice') ?? 'Min' }}" class="w-1/2 h-9 px-3 rounded-lg border border-nt-green/20 bg-nt-cream text-sm">
              <input type="number" name="max" value="{{ $max }}" placeholder="{{ __('messages.MaxPrice') ?? 'Max' }}" class="w-1/2 h-9 px-3 rounded-lg border border-nt-green/20 bg-nt-cream text-sm">
            </div>
          </div>
