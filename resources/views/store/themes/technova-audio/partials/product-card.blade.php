...
<div class="group bg-white rounded-2xl border border-slate-200/80 hover:border-blue-500/50 hover:shadow-tech-hover transition-all duration-300 flex flex-col justify-between overflow-hidden relative">
    ...
    <!-- Wishlist Button -->
    <button type="button" class="absolute top-3 right-3 z-10 w-8 h-8 rounded-full bg-white/90 backdrop-blur-sm border border-slate-200 text-slate-400 hover:text-red-500 hover:bg-white flex items-center justify-center transition shadow-sm" title="{{ __('messages.AddToWishlist') ?? 'Add to Wishlist' }}">
