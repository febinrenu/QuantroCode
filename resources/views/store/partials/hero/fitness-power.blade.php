...
<section class="store-hero py-16 relative overflow-hidden text-center"
         style="background:rgb(var(--color-fg-primary)); background-image:repeating-linear-gradient(45deg, rgb(var(--color-accent-500)/.1) 0px, rgb(var(--color-accent-500)/.1) 14px, transparent 14px, transparent 30px);">
  <div class="container">
