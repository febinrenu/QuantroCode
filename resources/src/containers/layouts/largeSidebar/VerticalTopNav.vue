<template>
  <div class="vertical-top-nav">
    <div class="nav-left">
      ...
      <div v-if="isDashboard" class="qtn-title">
        <div class="qtn-title-heading">{{ $t('dashboard') }}</div>
        <div class="qtn-title-sub">{{ $t('Welcome_back_message', { username: currentUser && currentUser.username }) }}</div>
      </div>
    </div>
    ...
    <div class="nav-right">
      ...
      >
        ...
        <span class="btn-text">{{ isDashboard ? 'Open POS' : 'POS' }}</span>
      </router-link>

      <!-- EN / AR quick toggle -->
      <div v-if="show_language" class="qtn-lang-toggle">
        <button type="button" :class="['qtn-lang-btn', { active: currentLocale !== 'ar' }]" @click="SetLocal('en')">EN</button>
        <button type="button" :class="['qtn-lang-btn qtn-lang-btn--ar', { active: currentLocale === 'ar' }]" @click="SetLocal('ar')">العربية</button>
      </div>
...
.nav-right .btn.btn-primary:focus,
.nav-right .btn.btn-primary:active,
body.dark-theme .nav-right .btn.btn-primary:hover,
body.dark-theme .nav-right .btn.btn-primary:focus,
body.dark-theme .nav-right .btn.btn-primary:active {
...
/* ===== Quantro tenant header: title, lang toggle, user meta ===== */
.nav-left { gap: 14px; }
.qtn-title { line-height: 1.15; }
.qtn-title-heading {
...
body.dark-theme .qtn-title-heading { color: #EAF1FA; }
body.dark-theme .qtn-title-sub { color: #71839E; }
...
body.dark-theme .qtn-lang-btn { color: #71839E; }
body.dark-theme .qtn-lang-btn.active { background: #1B3050; color: #6EA0FF; }
...
.qtn-user-meta { text-align: left; line-height: 1.2; }
.qtn-user-meta strong {
  display: block;
  font-weight: 600;
  font-size: 12px;
  color: #0B1B33;
...
body.dark-theme .qtn-user-meta strong { color: #EAF1FA; }
html[dir="rtl"] .qtn-user-meta,
html[dir="rtl"] .qtn-title { text-align: right; }

@media (max-width: 992px) {
  .qtn-title-sub, .qtn-user-meta { display: none; }
  .qtn-title-heading { font-size: 15px; }
}
</style>
