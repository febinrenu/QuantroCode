...
class StoreFrontController extends Controller
{
    ...
    protected function getThemedCategories(string $activeTheme)
    {
        ...
        // Generic fallback for category-specific themes that declare
        // product_category_keywords in their theme.json (e.g. HomeLuxe,
        // PawLuxe, TrailPeak, ShopIQ Electronics) rather than a hardcoded
        // category name list above.
        $themeCategoryIds = $this->themeCategoryIds($activeTheme);
