...
class SeedIndustryCatalog extends Command
{
     ...
     */
    /**
     * The PawLuxe theme ships with real bundled photos for its 5 Pet
     * Supplies & Accessories products so that category doesn't depend on an
     * Unsplash API key to look right.
     */
    private function bundledProductImage(string $name, string $dir): ?string
    {
        $bundled = [
            'Comfort Dog Leash & Collar Set' => 'pawluxe/leash-collar.jpg',
            'Interactive Cat Toy' => 'pawluxe/cat-toy.jpg',
            'Ceramic Pet Food Bowl' => 'pawluxe/food-bowl.jpg',
            'Cozy Pet Bed' => 'pawluxe/pet-bed.jpg',
            'Aquarium Fish Tank' => 'pawluxe/aquarium.jpg',
        ];
