...
call npm install
echo.
echo Building Storefront + Admin Assets (includes the storefront theme packs)...
call npm run production
echo.
echo Running Automated Database Configuration...
php setup_local_env.php
echo.
echo Applying Tenant Migrations (adds the storefront theme_tokens column, etc.)...
call php artisan tenants:migrate --force
echo.
